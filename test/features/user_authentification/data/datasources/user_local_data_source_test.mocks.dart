...
// in faro_clean_tdd/test/features/user_authentification/data/datasources/user_local_data_source_test.dart.
...
class MockDatabaseFactory extends _i1.Mock implements _i2.DatabaseFactory {
  ...
  @override
  _i3.Future<_i2.Database> openDatabase(
    String? path, {
  ...
  @override
  _i3.Future<String> getDatabasesPath() => (super.noSuchMethod(
        Invocation.method(
          #getDatabasesPath,
          [],
        ),
  ...
  @override
  _i3.Future<void> setDatabasesPath(String? path) => (super.noSuchMethod(
        Invocation.method(
          #setDatabasesPath,
          [path],
        ),
  ...
  @override
  _i3.Future<void> deleteDatabase(String? path) => (super.noSuchMethod(
        Invocation.method(
          #deleteDatabase,
          [path],
        ),
  ...
  @override
  _i3.Future<bool> databaseExists(String? path) => (super.noSuchMethod(
        Invocation.method(
          #databaseExists,
          [path],
        ),
  ...
  @override
  _i3.Future<void> writeDatabaseBytes(
    String? path,
    _i4.Uint8List? bytes,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<_i4.Uint8List> readDatabaseBytes(String? path) =>
      (super.noSuchMethod(
        Invocation.method(
          #readDatabaseBytes,
          [path],
